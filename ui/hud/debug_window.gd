...
@onready var status_label = $Anchor/MarginContainer/PanelContainer/MarginContainer/HBoxContainer/VBoxContainer/StatusLabel
@onready var error_label = $Anchor/MarginContainer/PanelContainer/MarginContainer/HBoxContainer/VBoxContainer/ErrorLabel
...
func _ready():
	...
	# Quando il pulsante viene premuto, esegue hide_display
	close_button.pressed.connect(hide_display)
